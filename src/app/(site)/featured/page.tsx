...
const PRODUCT_FIELDS = "id,title,handle,subtitle,thumbnail,created_at,*variants,*variants.prices,*variants.inventory_quantity,+metadata,*tags,*type,*attribute_values,*attribute_values.attribute_type"
