...
export default function ConsignmentPage({
  ...
  const c = {
    ...
    diffBoxTitle:  text.diffBoxTitle  ?? '',
    options: [
      { heading: text.option1Heading ?? '', body: text.option1Body ?? '', link: text.option1Link, linkText: text.option1LinkText },
      { heading: text.option2Heading ?? '', body: text.option2Body ?? '', link: text.option2Link, linkText: text.option2LinkText },
    ...
    salesEmailResponseTime: text.salesEmailResponseTime ?? '',
    formHeading:   text.formHeading   ?? '',
    steps: [
      [text.step1Title ?? '', text.step1Body ?? ''],
      [text.step2Title ?? '', text.step2Body ?? ''],
      [text.step3Title ?? '', text.step3Body ?? ''],
      [text.step4Title ?? '', text.step4Body ?? ''],
    ] as [string, string][],
    outrightBoxBody:     text.outrightBoxBody ?? '',
