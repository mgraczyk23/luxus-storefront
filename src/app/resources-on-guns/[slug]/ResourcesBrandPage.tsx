  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', width: '100%', aspectRatio: '4/3', overflow: 'hidden', flexShrink: 0, background: '#f0f0f0' }}>
        ...
        {/* Availability badge */}
        <div className="lxs-card-badge-avail" style={{ position: 'absolute', top: '8px', right: '8px', display: 'flex', alignItems: 'center', background: 'rgba(255,255,255,0.88)', border: `1px solid ${product.in_stock ? '#3a6a3a55' : '#6a3a3a55'}`, padding: '3px 8px', backdropFilter: 'blur(6px)' }}>
    ...
    <div style={{ background: t.bg, minHeight: '100vh' }}>
      ...
      <div style={{ position: 'relative', height: heroUrl ? 'clamp(260px,50vw,480px)' : '220px', overflow: 'hidden', background: heroUrl ? undefined : t.bgSurface }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', padding: '0 24px 44px', textAlign: 'center' }}>
          {logoUrl && (
            <div style={{ width: 'clamp(140px, 16vw, 220px)', height: 'clamp(140px, 16vw, 220px)', position: 'relative', marginBottom: '14px', filter: heroUrl ? 'brightness(0) invert(1)' : undefined }}>
