          ...
          <div className="lxs-contact-hero">
            <div>
              ...
              <p style={{ fontSize:"14.5px",fontWeight:300,color:t.textMuted,lineHeight:1.82,maxWidth:"420px",letterSpacing:"0.02em" }}>
                Whether you&apos;re inquiring about a specific piece, considering a consignment, or simply want to talk firearms with someone who cares as much as you do, our team is here.
              </p>
            </div>
          ...
          <div>
            ...
            {formStatus === "success" ? (
              <div style={{ padding:"60px 40px",border:`1px solid ${t.border}`,background:"#fff",textAlign:"center" }}>
                ...
                <button onClick={() => { setFormStatus("idle"); setForm({ firstName:"",lastName:"",email:"",phone:"",company:"",topic:TOPICS[0],message:"",newsletter:false }) }}
      ...
      <section style={{ padding:"80px 40px",margin:"64px 0 0",background:"#f3f3f5",borderTop:`1px solid ${t.border}`,borderBottom:`1px solid ${t.border}` }}>
        <div style={{ maxWidth:"1440px",margin:"0 auto" }}>
          ...
          <div className="lxs-contact-expect">
            {[
              { n:"01", title:"We Read Every Message",   body:"No automated routing, no ticket queue. Every message is read by a team member who knows the inventory." },
              { n:"02", title:"Honest, Direct Replies",  body:"If we don't have the piece you're after, we'll tell you, and often suggest where you might find it." },
