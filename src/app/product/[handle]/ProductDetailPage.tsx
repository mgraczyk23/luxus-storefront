      ...
      >
        ...
        <div style={{ padding: "16px 18px 20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <span style={{ fontSize: "9px", letterSpacing: "0.12em", textTransform: "uppercase", color: t.gold, borderBottom: `1px solid ${t.gold}55`, paddingBottom: "1px", opacity: hov ? 1 : 0.65, transition: "opacity 0.2s" }}>
              View Details
            </span>
          </div>
        </div>
      ...
      <div style={{ paddingTop: "68px", background: isDark ? t.bgSurface : t.bgSurface, borderBottom: `1px solid ${t.border}` }}>
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "14px 40px", display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
          {[
            ...
            ...(product.brand ? [{ label: product.brand, href: `/shop?brand=${encodeURIComponent(product.brand)}` }] : []),
          ].map(crumb => (
