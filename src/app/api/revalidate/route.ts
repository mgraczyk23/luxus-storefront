...
const STATIC_TAGS = new Set(['site-settings', 'posts', 'comments', 'subscribers', 'products', 'hero-slides', 'about-page', 'consignment-page', 'faq-page', 'brands', 'shop-tile-images', 'policy-shipping', 'policy-privacy', 'policy-terms'])
