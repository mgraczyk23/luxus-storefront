...
const SOCIAL = [
  {
    ...
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M18 2H15C13.67 2 12.4 2.53 11.46 3.46C10.53 4.4 10 5.67 10 7V10H7V14H10V22H14V14H17L18 10H14V7C14 6.73 14.11 6.48 14.29 6.29C14.48 6.11 14.73 6 15 6H18V2Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  },
  {
    label: "Instagram",
    href: "https://instagram.com",
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" stroke="currentColor" strokeWidth="1.5"/><circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="1.5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg>,
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com",
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M16 8C17.59 8 19.12 8.63 20.24 9.76C21.37 10.88 22 12.41 22 14V21H18V14C18 13.47 17.79 12.96 17.41 12.59C17.04 12.21 16.53 12 16 12C15.47 12 14.96 12.21 14.59 12.59C14.21 12.96 14 13.47 14 14V21H10V14C10 12.41 10.63 10.88 11.76 9.76C12.88 8.63 14.41 8 16 8Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><rect x="2" y="9" width="4" height="12" stroke="currentColor" strokeWidth="1.5"/><circle cx="4" cy="4" r="2" stroke="currentColor" strokeWidth="1.5"/></svg>,
  },
  {
    label: "X / Twitter",
    href: "https://x.com",
    icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M4 4L20 20M20 4L4 20" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>,
  },
  {
    label: "YouTube",
...
export default function Footer() {
  ...
  const linkStyle: React.CSSProperties = {
    ...
    letterSpacing: "0.02em", transition: "color 0.15s", cursor: "pointer",
    textDecoration: "none", display: "block",
  }

  return (
    <footer style={{ background: isDark ? "#080808" : t.bg, padding: "72px 40px 0", fontFamily: "'Inter',sans-serif", borderTop: `1px solid ${t.border}` }}>
      <div style={{ maxWidth: "1440px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "60px", marginBottom: "60px" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "12px", fontWeight: 300, lineHeight: 1.85, color: "#525258", maxWidth: "260px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "9px", marginTop: "22px" }}>
              {[
                { href: "tel:9412533660",               icon: "phone", label: "(941) 253-3660" },
                { href: "tel:8334866659",               icon: "phone", label: "(833) 486-6659 · Toll-Free" },
                { href: "mailto:info@luxus-collection.com", icon: "email", label: "info@luxus-collection.com" },
              ].map(({ href, icon, label }) => (
        ...
        {/* Bottom bar */}
        <div style={{ borderTop: `1px solid ${isDark ? "#1a1a1a" : t.border}`, padding: "22px 0", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px", flexWrap: "wrap" }}>
            <Link href="/privacy" style={{ fontSize: "9.5px", color: isDark ? "#8a8a90" : t.gold, letterSpacing: "0.06em", transition: "color 0.15s" }}
              onMouseEnter={e => (e.currentTarget.style.color = isDark ? DARK.gold : LIGHT.gold)}
              onMouseLeave={e => (e.currentTarget.style.color = isDark ? "#8a8a90" : t.gold)}>
              Privacy Policy
            </Link>
            <Link href="/terms" style={{ fontSize: "9.5px", color: isDark ? "#8a8a90" : t.gold, letterSpacing: "0.06em", transition: "color 0.15s" }}
              onMouseEnter={e => (e.currentTarget.style.color = isDark ? DARK.gold : LIGHT.gold)}
              onMouseLeave={e => (e.currentTarget.style.color = isDark ? "#8a8a90" : t.gold)}>
              Terms &amp; Conditions
            </Link>
